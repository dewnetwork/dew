...
| [`.github/workflows/release-please.yml`](./.github/workflows/release-please.yml) | Release Please (Conventional Commits → tag) + binaries + GHCR images |
| [`.github/workflows/release-binaries.yml`](./.github/workflows/release-binaries.yml) | Re-upload release binaries for tag `v*` / manual |
| [`.github/workflows/release-images.yml`](./.github/workflows/release-images.yml) | Multi-arch Docker images → GHCR (`dew`, faucet, explorer, guestbook) |
